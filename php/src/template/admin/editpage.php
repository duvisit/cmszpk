...
<div class="uk-form-row">
<label class="uk-form-label" for="menuid">Menu ID</label>
<div class="uk-form-controls">
<input class="uk-form-width-small" required
    type="text" id="menuid" name="menuid"
    value="<?php echoOutput( $page['menuid'] ); ?>">
</div>
</div>
